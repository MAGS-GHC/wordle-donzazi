const targetWords = [
  ...
  "rural",
  "shave",
]; // "targetWords" array is all the different words that are going to be used as a daily word.
const dictionary = [
  "aahed",
  "aalii",
  "aargh",
  ...
  "rural",
  "shave",
]; // "dictionary" is every 5 word letter that is accepted by our game.

let WORD_LENGTH = 5;
let FLIP_ANIMATION_DURATION = 500;
...
function handleMouseClick(e) {
  ...
  if (e.target.mathes("[data-delete]")) {
    deleteKey();
    return;
  }
}
